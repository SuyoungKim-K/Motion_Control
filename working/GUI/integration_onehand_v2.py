...
def cv_gui_arduino(p_list, maximum,):
    ...
    class Enter_mode:
        ...
        def select_mode(self, select_idx):
            ...
            if select_idx < 0:
                if right_idx_1 > 55 and mode_global != 1:
                    mode_global = 1
                    print('mode 1')
                    select_idx = 50 * 30

                elif left_idx_1 > 55 and mode_global != 2:
                    mode_global = 2
                    print('mode 2')
                    select_idx = 50 * 30

                elif (right_idx_1 < 55 and mode_global != 0) and (left_idx_1 < 55 and mode_global != 0) :
                    mode_global = 0
                    print('mode 0')
            select_idx -= 1
            return select_idx
    ...
    class opcv(QThread):
        ...
        def run(self):  # p를 보는 emit 함수
            ...
            while self.bool_state and cap.isOpened():
                ...
                if results.multi_hand_landmarks:
                    ...
                    for hand_landmarks in results.multi_hand_landmarks:  # hand_landmarks는 감지된 손의 갯수만큼의 원소 수를 가진 list 자료구조
                        ...
                        # print(type(hand_landmarks.classification[0]), hand_landmarks.classification[0])
                    for i in range(len(mark_p_list)):
                        # print(results.multi_hand_landmarks[i])
                        left_or_right_list.append(results.multi_handedness[i].classification[0].label) # results.multi_handedness[i].classification[0].label
                    ...
                    elif mode_global == 2 : # 왼손으로 트리거 했을 때
                    ...
                    HM_2 = Handmark(mark_p_list[rl_idx])
                    HM_2.predict_gesture(p_list, maximum)
            ...
            try:
                ...
                pass
            self.change_pixmap_signal.emit(cv2.cvtColor(cv2.imread('Image/touch_mode_screen.png'), cv2.COLOR_BGR2RGB))
            hands.close()
    ...
    class Ui_MainWindow(QtWidgets.QMainWindow):
        ...
        def change_label_6(self, change_pixmap_signal_2):
            if change_pixmap_signal_2 == 0 :
                ...
                self.label_6.setPixmap(QtGui.QPixmap("Image/gesture_ing.PNG"))
    ...
    class Ui_Dialog(object): # 가이드 윈도우
        def setupUi(self, Dialog):
            ...
            self.label_31.setPixmap(QtGui.QPixmap("Image/guide_4.PNG"))
            self.label_31.setScaledContents(True)
            self.label_31.setObjectName("label_31")
            self.label_2 = QtWidgets.QLabel(self.frame)
            self.label_2.setGeometry(QtCore.QRect(30, 1340, 711, 291))
            self.label_2.setText("")
            self.label_2.setPixmap(QtGui.QPixmap("Image/guide_5.png"))
            self.label_2.setScaledContents(True)
            self.label_2.setObjectName("label_2")
            ...
            self.label_38.setPixmap(QtGui.QPixmap("Image/down.png"))
            ...
            self.label_37.setPixmap(QtGui.QPixmap("Image/up.png"))
            ...
            self.label_39.setPixmap(QtGui.QPixmap("Image/stop.png"))
            ...
            self.label_40.setPixmap(QtGui.QPixmap("Image/guide_3.PNG"))
