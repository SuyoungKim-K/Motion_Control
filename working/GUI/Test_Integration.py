...
def cv_gui_arduino(p_list, maximum, p_list_2, maximum_2):
    ...
    class Handmark():
        ...
        def return_finger_info(self):
            ...
            result = self.finger_state_distance
    ...
    class test_mode(QThread):
        ...
        def run(self):
            ...
            filename = './TEST/' + str(now) + ".avi"
            video = cv2.VideoWriter(filename,
                                    self.fourcc, 30.0, (w, h))
            while self.record:
    ...
    class Ui_MainWindow(QtWidgets.QMainWindow):
        ...
        def setupUi(self, MainWindow):
            ...
            self.pushButton_5.setGeometry(QtCore.QRect(1340, 20, 20, 20))
            self.pushButton_5.setText("Test")
            ...
            self.pushButton_5.toggled.connect(self.recording)
            self.thread = opcv()
            ...
            self.thread.change_pixmap_signal.connect(self.thread_3.new_frmae)
            Form.deleteLater()
            # Form = None
...
def data_predict(p_list, maximum):
    ...
    try:
        model = keras.models.load_model(
            '../model_save/my_model_63_renewal.h5'
        )
    except:
        print('ML 모델 로딩 실패')
    while True:
